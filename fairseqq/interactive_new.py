...
Translation = namedtuple('Translation', 'src_str hypos pos_scores alignments wbh')
...
def load(args):
    ...
    return task, align_dict, models, tgt_dict, translator, use_cuda

def translate(task, align_dict, models, tgt_dict, translator, args, use_cuda, pre_input):
...
#    print('| Type the input sentence and press return:')
    ...
    for i in np.argsort(indices):
        ...
        #for hypo, pos_scores, align, wbh in zip(result.hypos, result.pos_scores, result.alignments, result.wbh):
            #rhypo.append(hypo)
            #ralign.append(ralign)
            # print(hypo)
            # print(pos_scores)
